...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, text="Soon",
        ...
        self.string_input_button = customtkinter.CTkButton(self.tabview.tab("calculations"), text="calculate confusion matrix",
    ...
    def calculate_accuracy(self):
        ...
        test_loss, test_acc = modell.evaluate(validation_generator, verbose=2)
